...
void main() {
  ...
  test('v1 库迁移：每条旧日记生成一条 text Block', () async {
    ...
    expect(history[11]['from'], 12);
    expect(history[11]['to'], 13);
    expect(history[12]['from'], 13);
    expect(history[12]['to'], 14);
    expect(history[13]['from'], 14);
    expect(history[13]['to'], 15);
    expect(history[14]['from'], 15);
    expect(history[14]['to'], 16);
    expect(history[15]['from'], 16);
    expect(history[15]['to'], 17);
    expect(history[16]['from'], 17);
    expect(history[16]['to'], 18);
    expect(history[17]['from'], 18);
    expect(history[17]['to'], 19);
    expect(history.last['from'], 19);
    expect(history.last['to'], 20);
  });
  ...
  test('v3→v4：历史 Block 回填 source=initial', () async {
    ...
    expect(history[9]['from'], 12);
    expect(history[9]['to'], 13);
    expect(history[10]['from'], 13);
    expect(history[10]['to'], 14);
    expect(history[11]['from'], 14);
    expect(history[11]['to'], 15);
    expect(history[11]['from'], 14);
    expect(history[11]['to'], 15);
    expect(history[12]['from'], 15);
    expect(history[12]['to'], 16);
    expect(history[13]['from'], 16);
    expect(history[13]['to'], 17);
    expect(history[14]['from'], 17);
    expect(history[14]['to'], 18);
    expect(history[15]['from'], 18);
    expect(history[15]['to'], 19);
    expect(history.last['from'], 19);
    expect(history.last['to'], 20);
  });
