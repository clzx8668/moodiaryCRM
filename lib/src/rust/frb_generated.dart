...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiFfiApiShutdown();

  Future<void> crateApiEventBusShutdownAll();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<int> crateApiFfiApiApiVersion() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFfiApiApiVersionConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFfiApiApiVersionConstMeta =>
  ...
  Future<String> crateApiFfiApiGetSyncStatus() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFfiApiGetSyncStatusConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFfiApiGetSyncStatusConstMeta =>
  ...
  Future<void> crateApiFfiApiShutdown() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFfiApiShutdownConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFfiApiShutdownConstMeta =>
  ...
  Future<void> crateApiEventBusShutdownAll() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiEventBusShutdownAllConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiEventBusShutdownAllConstMeta =>
  ...
  Future<List<String>> crateApiFfiApiSyncProgressEventsSince({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_i_64(sinceTimestamp, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 38,
        ...
        constMeta: kCrateApiFfiApiSyncProgressEventsSinceConstMeta,
  ...
  TaskConstMeta get kCrateApiFfiApiSyncProgressEventsSinceConstMeta =>
      const TaskConstMeta(
        debugName: "sync_progress_events_since",
  ...
  Future<void> crateApiFfiApiTriggerFullSync() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFfiApiTriggerFullSyncConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFfiApiTriggerFullSyncConstMeta =>
      const TaskConstMeta(debugName: "trigger_full_sync", argNames: []);
